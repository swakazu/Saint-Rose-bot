...
# Хранилища
private_rooms = {}  # {channel_id: owner_id}
panel_messages = {}  # {channel_id: message_id}
...
class RoomPanel(discord.ui.View):
    ...
    @discord.ui.button(label="👑 назначить нового создателя комнаты", style=discord.ButtonStyle.secondary, row=0)
    ...
    @discord.ui.button(label="🔐 ограничить/выдать доступ к комнате", style=discord.ButtonStyle.secondary, row=0)
    ...
    @discord.ui.button(label="👥 задать новый лимит участников", style=discord.ButtonStyle.secondary, row=0)
    ...
    @discord.ui.button(label="🔒 закрыть/открыть комнату", style=discord.ButtonStyle.secondary, row=1)
    ...
    @discord.ui.button(label="✏️ изменить название комнаты", style=discord.ButtonStyle.secondary, row=1)
    ...
    @discord.ui.button(label="👁️ скрыть/открыть комнату", style=discord.ButtonStyle.secondary, row=1)
    ...
    @discord.ui.button(label="👢 выгнать участника из комнаты", style=discord.ButtonStyle.danger, row=2)
    ...
    @discord.ui.button(label="🎤 ограничить/выдать право говорить", style=discord.ButtonStyle.secondary, row=2)
...
async def create_voice_room(member: discord.Member):
    """Создание комнаты при заходе в канал"""
    ...
    # Создаём панель управления в текстовый канал комнаты
    embed = discord.Embed(
...
def setup_private_voice(bot):
    ...
    async def on_voice_state_update(member: discord.Member, before: discord.VoiceState, after: discord.VoiceState):
        ...
        # Если комната опустела - удаляем через 30 секунд
    ...
    @bot.tree.command(name="админ_панель_комнат", description="Создать панель управления приватными комнатами")
    async def admin_panel(interaction: discord.Interaction):
        """Создаёт панель с информацией о приватных комнатах"""
        ...
        embed = discord.Embed(
            ...
            description="**Измените конфигурацию вашей комнаты с помощью панели управления.**\n\n"
                       ...
                       "• 👢 выгнать участника из комнаты\n"
                       "• 🎤 ограничить/выдать право говорить\n\n"
                       f"**Как создать комнату:** Зайдите в голосовой канал <#{PRIVATE_VOICE_CREATE_CHANNEL_ID}>",
            color=discord.Color.purple()
        )
