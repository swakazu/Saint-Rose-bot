...
from config import TICKET_CATEGORY_ID, ADMIN_ROLES_IN_ORDER
    ...
    async def setup_tickets(interaction: discord.Interaction):
        ...
        embed = discord.Embed(
            ...
            description="**Выберите тип обращения:**\n\n"
                       "• **⚠️ Амнистия** — запрос на снятие наказания\n"
                       "• **💡 Предложение** — идеи по улучшению\n"
                       "• **😊 Помощь** — проблемы и вопросы\n"
                       "• **🔴 Жалоба на админа** — нарушение правил\n"
                       "• **👑 Заявка на Helper** — стать частью команды",
